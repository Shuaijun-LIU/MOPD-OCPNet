...
from GeoTIFF_Data import Get_GeoTIFF_Data, analyze_geotiff, tif_to_csv, visualize_elevation_map
import rasterio
import numpy as np
import os
...
''' ------------- STEP 2. GOPAF: Get Currents Forecast Data --------------- '''
...
from GOPAF_Data import get_shapes
if __name__ == "__main__":
    file_path = "./Data/GOPAF/combined_gopaf_data.nc"
...
interpolate_and_merge('./output/filtered_data.tif', './Data/GOPAF/combined_gopaf_data.nc', './Data/Combined')
...
#     print("Failed")
#
# interpolate_and_merge('./output/interpolated_data.tif', './Data/GOPAF/combined_gopaf_data.nc', './Data/Combined/large')
